...
export class BaAmChartThemeService {
  ...
  /* tslint:disable */
  getTheme() {
    let layoutColors = this._baConfig.getConfig().colors;
    ...
    return {
      ...
      AmCoordinateChart: {
        colors: [layoutColors.primary, layoutColors.danger, layoutColors.warning, layoutColors.primaryDark, layoutColors.info, layoutColors.primaryDark, layoutColors.warningLight, layoutColors.successDark, layoutColors.successLight, layoutColors.primaryLight, layoutColors.warningDark]
      },
